...
void add_FIRST_A_to_FOLLOW_B(char A, char 😎 {
    int i;
    for (i = 0; i < TSIZE; ++i) {
        if (i != '^')
...
void add_FOLLOW_A_to_FOLLOW_B(char A, char 😎 {
    int i;
    for (i = 0; i < TSIZE; ++i) {
        if (i != '^')
...
void add_FIRST_A_to_FIRST_B(char A, char 😎 {
    int i;
    for (i = 0; i < TSIZE; ++i) {
        if (i != '^') {
...
void add_FIRST_A_to_FIRST_RHS__B(char A, int 😎 {
    int i;
    for (i = 0; i < TSIZE; ++i) {
        if (i != '^')
